...
function ButtonSolo() {
  return (
    <button
      className="flex justify-center gap-2 items-center mx-auto shadow-xl text-lg text-gray-50 bg-primary backdrop-blur-md lg:font-medium isolation-auto before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-secondary-orange hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-8 py-4 overflow-hidden border-2 rounded-full group"
      type="submit"
    >
      Give Us a Shout
      <svg
